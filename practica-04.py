...
# Se pide definir una función
# "ponderacion_por_verosimilitud(var,observado,red,N)" que implemente un
# cálculo aproximado de la probabilidad P(var|observado), respecto de una red
# bayesiana dada, usando el método de ponderación por verosimilitus
# (transparencias 100-103 del tema 7). El número N indica el número de
